  ...
  return (
    <div className="bg-primary-bg w-full">
      ...
      <div className="hidden md:flex gap-6 lg:gap-16 p-3 bg-secondary-bg items-center justify-center w-full">
        <Link
          to="/browse"
          className="flex items-center gap-2 text-black hover:text-primary-button transition-colors"
        >
          Browse Tutors
        </Link>
        <Link
          to="/appointments"
          className="flex text-primary items-center gap-2 text-black hover:text-primary-button transition-colors"
        >
          View Appointments
        </Link>
        <Link
